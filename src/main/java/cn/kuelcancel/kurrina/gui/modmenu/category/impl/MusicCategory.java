...
import cn.kuelcancel.kurrina.management.music.MusicType;
...
import cn.kuelcancel.kurrina.ui.comp.impl.field.CompTextBox;
...
public class MusicCategory extends Category {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		for(Music m : musicManager.getMusics()) {
			...
			if(m.getIcon() == null) {
				nvg.drawRoundedImage(new ResourceLocation("kurrina/music.png"), this.getX() + 21, this.getY() + offsetY + 6, 34, 34, 6);
			}else {
		...
		if(currentMusic == null || currentMusic.getIcon() == null) {
			nvg.drawRoundedImage(new ResourceLocation("kurrina/music.png"), this.getX() + 15, this.getY() + this.getHeight() - 40F, 34, 34, 6);
		}else {
