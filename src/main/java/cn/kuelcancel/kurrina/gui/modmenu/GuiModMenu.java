package cn.kuelcancel.kurrina.gui.modmenu;
...
import cn.kuelcancel.kurrina.gui.GuiEditHUD;
import cn.kuelcancel.kurrina.gui.modmenu.category.Category;
import cn.kuelcancel.kurrina.gui.modmenu.category.impl.CosmeticsCategory;
import cn.kuelcancel.kurrina.gui.modmenu.category.impl.HomeCategory;
import cn.kuelcancel.kurrina.gui.modmenu.category.impl.ModuleCategory;
import cn.kuelcancel.kurrina.gui.modmenu.category.impl.MusicCategory;
import cn.kuelcancel.kurrina.gui.modmenu.category.impl.ProfileCategory;
import cn.kuelcancel.kurrina.gui.modmenu.category.impl.ScreenshotCategory;
...
public class GuiModMenu extends GuiScreen {
	...
	private void drawNanoVG(int mouseX, int mouseY, float partialTicks) {
		...
		nvg.drawText(Icon.Kurrina, x + 8, y + 10, Color.WHITE, 16, Fonts.ICON);
	...
	public void onGuiClosed() {
		Kurrina.getInstance().getProfileManager().save();
	}
