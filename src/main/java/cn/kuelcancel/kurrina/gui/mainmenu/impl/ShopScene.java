...
public class ShopScene extends MainMenuScene {
	...
	public ShopScene(GuiKurrinaMainMenu parent) {
		super(parent);
	...
	private void drawNanoVG(int mouseX, int mouseY, ScaledResolution sr, Kurrina instance, NanoVGManager nvg) {
		...
		nvg.drawCenteredText("??￥ / " + TranslateText.LIFETIME.getText(), acX + 20 + (82 / 2), acY + 71, Color.WHITE, 8, Fonts.REGULAR);
