package cn.kuelcancel.kurrina.management.account;
...
import cn.kuelcancel.kurrina.management.account.microsoft.MicrosoftAuthentication;
...
public class AccountManager {
	...
	public AccountManager() {
		...
		File accountFile = new File(fileManager.getKurrinaDir(), "Account.json");
	...
	public void save() {
		...
		try (FileWriter writer = new FileWriter(new File(fileManager.getKurrinaDir(), "Account.json"))) {
			...
			KurrinaLogger.error("Failed to save account", e);
		}
	}
	...
	public void load() {
		...
		try (FileReader reader = new FileReader(new File(fileManager.getKurrinaDir(), "Account.json"))) {
			...
			KurrinaLogger.error("Failed to load account", e);
		}
	}
