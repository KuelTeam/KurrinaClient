...
public class LanguageManager {
	...
	private void loadMap(HashMap<String, String> map, String language) {
		...
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(LanguageManager.class.getClassLoader().getResourceAsStream("assets/minecraft/kurrina/language/" + language + ".properties"), StandardCharsets.UTF_8))) {
			...
			KurrinaLogger.error("Failed to load translate", e);
		}
	}
