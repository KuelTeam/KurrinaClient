...
public enum TranslateText {
	...
	COMPACT("text.compact"), FOX("text.fox"), PHANTOM("text.phantom"), SELECT_BACKGROUND("text.selectbackground"), NIGHT("text.night"),
	...
	HEAD("text.head"), KEKE("text.keke"), LUCA("text.lucaaus"), BACKGROUND("text.background"), PROJECTILE_TRAIL("text.projectiletrail.name"), PROJECTILE_TRAIL_DESCRIPTION("text.projectiletrail.description"),
	ENGLISH("text.english"), CHINESE("text.chinese"), CHINESE_TRADITIONAL("text.chinese_traditional"), POLISH("text.polish"),
	...
	CHILL("text.chill"), Kurrina("text.kurrina"), MODERN_HOTBAR("text.modernhotbar.name"), MODERN_HOTBAR_DESCRIPTION("text.modernhotbar.description"),
	...
	WELCOME_TO_KURRINA("text.welcometokurrina"), CALENDAR("text.calendar.name"), CALENDAR_DESCRIPTION("text.calendar.description"),
