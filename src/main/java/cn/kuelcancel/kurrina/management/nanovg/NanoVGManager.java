package cn.kuelcancel.kurrina.management.nanovg;
...
import cn.kuelcancel.kurrina.management.nanovg.asset.AssetManager;
import cn.kuelcancel.kurrina.management.nanovg.font.Font;
import cn.kuelcancel.kurrina.management.nanovg.font.FontManager;
...
public class NanoVGManager {
	...
	public NanoVGManager() {
		...
		if(nvg == 0) {
			KurrinaLogger.error("Failed to create NanoVG context");
			mc.shutdown();
		}
