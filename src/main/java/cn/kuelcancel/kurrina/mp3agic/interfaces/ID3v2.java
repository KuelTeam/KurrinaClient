package cn.kuelcancel.kurrina.mp3agic.interfaces;

import java.util.ArrayList;
import java.util.Map;

import cn.kuelcancel.kurrina.mp3agic.ID3v2ChapterFrameData;
import cn.kuelcancel.kurrina.mp3agic.ID3v2ChapterTOCFrameData;
import cn.kuelcancel.kurrina.mp3agic.ID3v2FrameSet;
