...
public class CompColorPicker extends Comp {
	...
	public void draw(int mouseX, int mouseY, float partialTicks) {
		...
		nvg.drawRoundedImage(new ResourceLocation("kurrina/hue.png"), this.getX() + (106 * scale), this.getY(), 12 * scale, size, 3 * scale);
		...
		if(colorSetting.isShowAlpha()) {
			nvg.drawRoundedImage(new ResourceLocation("kurrina/alpha.png"), this.getX(), this.getY() + (106 * scale), size + (18 * scale), 12 * scale, 3 * scale);
