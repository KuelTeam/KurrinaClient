package cn.kuelcancel.kurrina.utils.file;
...
import cn.kuelcancel.kurrina.utils.file.filter.PngFileFilter;
import cn.kuelcancel.kurrina.utils.file.filter.SoundFileFilter;
...
public class FileUtils {
    ...
    public static void downloadFile(String url, File output) {
    	try {
    		...
    		KurrinaLogger.error("Failed to download file: " + url, e);
    	}
    }
