package cn.kuelcancel.kurrina.mobends.client.renderer;
...
import cn.kuelcancel.kurrina.management.mods.impl.MoBendsMod;
...
import cn.kuelcancel.kurrina.mobends.util.MoBendsGUtil;
...
public class SwordTrail {
	...
	public void render(ModelBendsPlayer model){
		...
		Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("kurrina/white.png"));
