package cn.kuelcancel.kurrina.injection.mixin;
...
import cn.kuelcancel.kurrina.injection.transformer.LwjglTransformer;
import net.minecraft.launchwrapper.ITweaker;
import net.minecraft.launchwrapper.Launch;
import net.minecraft.launchwrapper.LaunchClassLoader;

public class KurrinaTweaker implements ITweaker {
    ...
    public void injectIntoClassLoader(LaunchClassLoader classLoader) {
        ...
        Mixins.addConfiguration("mixins.kurrina.json");
